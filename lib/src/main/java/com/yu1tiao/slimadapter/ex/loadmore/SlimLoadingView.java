...
import com.yu1tiao.slimadapter.R;


public class SlimLoadingView extends View {
    ...
    public SlimLoadingView(Context context) {
        this(context, null);
    }

    public SlimLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlimLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.SlimLoadingView, defStyleAttr, 0);
        mPaintColor = array.getInt(R.styleable.SlimLoadingView_android_color, Color.GRAY);
        array.recycle();
        initPaint();
    }
